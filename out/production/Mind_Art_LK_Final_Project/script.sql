...
CREATE TABLE IF NOT EXISTS Customer(
    CusID VARCHAR(5) PRIMARY KEY NOT NULL,
    CusName VARCHAR(25),
...
CREATE TABLE IF NOT EXISTS Orders(
    OrderID VARCHAR(5) PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS Expense(
    ExpenID VARCHAR(5) PRIMARY KEY NOT NULL,
    ExpenType VARCHAR(15),
    ExpenAmount DECIMAL(8,2)
    );
SHOW TABLES;
DESCRIBE Expense;
...
CREATE TABLE IF NOT EXISTS Item(
    ItemCode VARCHAR(5) PRIMARY KEY NOT NULL,
    ItemName VARCHAR(20),
    QtyOnHand INT,
    UnitPrice double
    );
...
CREATE TABLE IF NOT EXISTS SupplierOrder(
    SupplierOrderID VARCHAR(5) PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS WoodType(
    WoodTypeID VARCHAR(5) PRIMARY KEY NOT NULL,
    WoodName VARCHAR(30)
    );
SHOW TABLES;
DESCRIBE WoodType;
